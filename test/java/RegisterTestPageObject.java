...
public class RegisterTestPageObject {
    ...
    private String path = "http://localhost:8080/pageobjectpairprogramming_Maarten_VanBriel_war_exploded/Controller";
    ...
    public void unsuccesfull_test_add_gives_an_error_message() {
        ...
        assertTrue(testRegisterPage.hasErrorMessage("Please fill out a value"));
    }
